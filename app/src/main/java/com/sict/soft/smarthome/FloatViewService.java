...
{  
    ...
    {  
        ...
        {  
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				case MotionEvent.ACTION_DOWN:
					mFloatView.setBackgroundResource(R.drawable.circle_green);
					isClick = false;
					break;
				...
				case MotionEvent.ACTION_UP:
					mFloatView.setBackgroundResource(R.drawable.circle_blue);
        ...
        mFloatView.setOnClickListener(new OnClickListener()   
        {
            ...
            {
                Intent intent = new Intent(FloatViewService.this,CeceActivity.class);
