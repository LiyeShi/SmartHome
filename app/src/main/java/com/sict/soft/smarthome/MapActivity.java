...
//        Toast.makeText(MapActivity.this,adress+"123",Toast.LENGTH_LONG).show();
    }
...
//                Toast.makeText(MapActivity.this,location.getAddrStr(),Toast.LENGTH_LONG).show();
                ...
                sb.append("\naddr : ");
                sb.append(location.getAddrStr());
                Toast.makeText(MapActivity.this,"您现在位于："+location.getAddrStr()+"\n大概位置："+location.getLocationDescribe(),Toast.LENGTH_LONG).show();
//运营商信息
                sb.append("\noperationers : ");
