...
import com.sict.soft.smarthome.bean.MyContacts;
import com.sict.soft.smarthome.dao.ContactsManagerDbAdater;
import com.sict.soft.smarthome.ui.PhotoEditorView;
...
public class EditJiarenActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v(TAG,"onCreate");
        setContentView(R.layout.activity_jiaren_edit);
    ...
    public class PhotoListener implements PhotoEditorView.EditorListener,
        ...
        private Dialog createPhotoDialog() {
            Context context = EditJiarenActivity.this;
