...
//        baiduMap.setMyLocationEnabled(true);
    ...
    private void navigateTo(BDLocation location) {
        if (isFirstLocate) {
            Toast.makeText(this, "您现在位于 " + location.getCity()+location.getDistrict()+location.getStreet(), Toast.LENGTH_LONG).show();
...
//            positionText.setText(currentPosition);
            // sendRequestWithHttpURLConnection(location.getLatitude()+""+location.getLongitude()+""+location.getCity()+""+location.getDistrict());
            JSONObject object = new JSONObject();

            try {
                object.put("Latitude", location.getLatitude());
                object.put("Longitude",location.getLongitude());
                //object.put("City",location.getCity()+location.getDistrict()+location.getStreet());
    ...
    private void sendRequestWithHttpURLConnection(final  String encodeString) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    URL url = new URL("http://192.168.0.104:11111/GPS");
                    ...
                    dop.writeBytes("Location="+ URLEncoder.encode(encodeString,"utf-8"));
